...
void TitleCard_InitBossName(GlobalContext* globalCtx, TitleCardContext* titleCtx, u8* texture, s16 x, s16 y, u8 width, u8 height);
void TitleCard_InitPlaceName(GlobalContext* globalCtx, TitleCardContext* titleCtx, u8* texture, s32 x, s32 y,
                             s32 width, s32 height, s32 startWaitTimer);
...
void Actor_VectorToPosSpeed(Actor* actor, f32 arg1);
s16 ActorSearch_AngleY(Actor* actorA, Actor* actorB);
s16 ActorSearch_PosAngleY(Actor* actor, Vec3f* arg1);
f32 ActorSearch_Distance(Actor* actorA, Actor* actorB);
s16 ActorSearch_AngleX(Actor* actorA, Actor* actorB);
s16 ActorSearch_PosAngleX(Actor* actor, Vec3f* arg1);
f32 ActorSearch_DistanceXZ(Actor* actorA, Actor* actorB);
f32 ActorSearch_PosDistanceXZ(Actor* actor, Vec3f* arg1);
void ActorSearch_PosProjectDistanceXZ(Actor* actor, Vec3f* result, Vec3f* arg2);
