...
void SkelAnime_LodDrawLimb(GlobalContext* globalCtx, s32 limbIndex, Skeleton* skeleton, Vec3s* limbDrawTable,
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 773);
    Matrix_Push();
    ...
    if ((overrideLimbDraw == NULL) || (overrideLimbDraw(globalCtx, limbIndex, &dList, &pos, &rot, actor) == 0)) {
        ...
        if (dList != NULL) {
            do {
                if (1) {
                    gSPMatrix(NEXT_DISP, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_skelanime.c", 805),
                              G_MTX_LOAD);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 821);
}
...
void SkelAnime_LodDraw(GlobalContext* globalCtx, Skeleton* skeleton, Vec3s* limbDrawTable,
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 849);
    Matrix_Push();
    ...
    if ((overrideLimbDraw == NULL) || (overrideLimbDraw(globalCtx, 1, &dList, &pos, &rot, actor) == 0)) {
        Matrix_JointPosition(&pos, &rot);
        if (dList != NULL) {
            gSPMatrix(NEXT_DISP, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_skelanime.c", 881), G_MTX_LOAD);
    ...
    Matrix_Pull();
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 894);
}
...
void SkelAnime_LodDrawLimbSV(GlobalContext* globalCtx, s32 limbIndex, Skeleton* skeleton, Vec3s* limbDrawTable,
    ...
    if ((overrideLimbDraw == NULL) || (overrideLimbDraw(globalCtx, limbIndex, &dList[1], &pos, &rot, actor) == 0)) {
        ...
        if (dList[1] != NULL) {
            ...
            OPEN_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 946);
            gSPMatrix(NEXT_DISP, *mtx, G_MTX_LOAD);
            gSPDisplayList(NEXT_DISP, dList[1]);
            CLOSE_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 949);
            (*mtx)++;
...
void SkelAnime_LodDrawSV(GlobalContext* globalCtx, Skeleton* skeleton, Vec3s* limbDrawTable, s32 dListCount,
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1000);
    gSPSegment(NEXT_DISP, 0xD, mtx);
    Matrix_Push();
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1053);
}
...
void SkelAnime_DrawLimb(GlobalContext* globalCtx, s32 limbIndex, Skeleton* skeleton, Vec3s* limbDrawTable,
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1076);
    Matrix_Push();
    ...
    if ((overrideLimbDraw == NULL) || (overrideLimbDraw(globalCtx, limbIndex, &dList, &pos, &rot, actor) == 0)) {
        ...
        if (dList != NULL) {
            do {
                if (1) {
                    gSPMatrix(NEXT_DISP, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_skelanime.c", 1103),
                              G_MTX_LOAD);
                    gSPDisplayList(NEXT_DISP, dList);
                }
            } while (0);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1121);
}
...
void SkelAnime_Draw(GlobalContext* globalCtx, Skeleton* skeleton, Vec3s* limbDrawTable,
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1148);
    Matrix_Push();
    ...
    if ((overrideLimbDraw == NULL) || (overrideLimbDraw(globalCtx, 1, &dList, &pos, &rot, actor) == 0)) {
        Matrix_JointPosition(&pos, &rot);
        if (dList != NULL) {
            gSPMatrix(NEXT_DISP, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_skelanime.c", 1176),
                      G_MTX_LOAD);
            gSPDisplayList(NEXT_DISP, dList);
        }
    }
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1190);
}
...
void SkelAnime_DrawLimbSV(GlobalContext* globalCtx, s32 limbIndex, Skeleton* skeleton, Vec3s* limbDrawTable,
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1214);
    Matrix_Push();
    ...
    if ((overrideLimbDraw == NULL) || (overrideLimbDraw(globalCtx, limbIndex, &dList[1], &pos, &rot, actor) == 0)) {
        ...
        if (dList[1] != NULL) {
            ...
            gSPMatrix(NEXT_DISP, *limbMatricies, G_MTX_LOAD);
            gSPDisplayList(NEXT_DISP, dList[1]);
            (*limbMatricies)++;
        } else if (dList[0] != NULL) {
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1265);
}
...
void SkelAnime_DrawSV(GlobalContext* globalCtx, Skeleton* skeleton, Vec3s* limbDrawTable, s32 dListCount,
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1294);
    ...
    Matrix_Pull();
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_skelanime.c", 1347);
}
