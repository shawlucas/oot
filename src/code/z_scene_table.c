...
void func_80099550(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 4725);

    gSPDisplayList(NEXT_DISP, sDefaultDisplayList);
    gSPDisplayList(NEXT_POLY_XLU_DISP, sDefaultDisplayList);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 4735);
}
...
void func_800995DC(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 4763);

    gSPSegment(NEXT_POLY_XLU_DISP, 0x09,
    ...
    gDPSetEnvColor(NEXT_POLY_XLU_DISP, 128, 128, 128, 128);

    { s32 pad; }

    gSPSegment(NEXT_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A2F8[gSaveContext.nightFlag]));

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 4783);
}
...
void func_80099760(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 4845);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 4859);
}
...
void func_80099878(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 4905);

    gameplayFrames = globalCtx->gameplayFrames;
    gSPSegment(NEXT_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A300[gSaveContext.nightFlag]));
    gSPSegment(NEXT_DISP, 0x09, SEGMENTED_TO_VIRTUAL(D_8012A308[(s32)(gameplayFrames & 14) >> 1]));
    gSPSegment(NEXT_POLY_XLU_DISP, 0x09,
               Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, (gameplayFrames * 1) % 256, 0, 64, 32, 1, 0,
                                (gameplayFrames * 1) % 128, 64, 32));
    gSPSegment(NEXT_DISP, 0x0A,
    ...
    gDPSetEnvColor(NEXT_DISP, 128, 128, 128, 128);

    gDPPipeSync(NEXT_POLY_XLU_DISP);
    gDPSetEnvColor(NEXT_POLY_XLU_DISP, 128, 128, 128, 128);

    gSPSegment(NEXT_DISP, 0x0B, displayListHead);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 4956);
}
...
void func_80099BD8(GlobalContext* globalCtx) {
    ...
    gSPSegment(NEXT_DISP, 0x0B, displayListHead);
    gSPSegment(NEXT_POLY_XLU_DISP, 0x0B, displayListHead);
    ...
    gSPSegment(NEXT_DISP, 0x0C, displayListHead);
    gSPSegment(NEXT_POLY_XLU_DISP, 0x0C, displayListHead);
    ...
    gSPSegment(NEXT_DISP, 0x0D, displayListHead);
    gSPSegment(NEXT_POLY_XLU_DISP, 0x0D, displayListHead);
    gDPPipeSync(displayListHead++);
...
void func_8009A45C(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5171);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5212);
}
...
void func_8009A798(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5226);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5264);
}
...
void func_8009A9DC(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5278);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5301);
}
...
void func_8009AB98(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5317);

    gameplayFrames = globalCtx->gameplayFrames;
    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, Gfx_TexScroll(globalCtx->state.gfxCtx, 0, gameplayFrames % 64, 256, 16));
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5330);
}
...
void func_8009ACA8(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5346);

    gameplayFrames = globalCtx->gameplayFrames;
    gSPSegment(NEXT_POLY_XLU_DISP, 0x08,
               Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 127 - gameplayFrames % 128, (gameplayFrames * 3) % 128, 32,
                                32, 1, gameplayFrames % 128, (gameplayFrames * 3) % 128, 32, 32));
    gSPSegment(NEXT_POLY_XLU_DISP, 0x09, Gfx_TexScroll(globalCtx->state.gfxCtx, 0, gameplayFrames % 64, 256, 16));
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5367);
}
...
void func_8009AE30(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5384);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5416);
}
...
void func_8009AFE0(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5490);
    ...
    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A328[gSaveContext.nightFlag]));

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5507);
}
...
void func_8009B0FC(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5535);
    ...
    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A330[gSaveContext.nightFlag]));
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5644);
}
...
void func_8009B86C(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5791);
    ...
    gDPPipeSync(NEXT_DISP);
    gDPSetEnvColor(NEXT_DISP, 128, 128, 128, globalCtx->unk_11D30[0]);

    gDPPipeSync(NEXT_POLY_XLU_DISP);
    gDPSetEnvColor(NEXT_POLY_XLU_DISP, 128, 128, 128, 145);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5808);
}
...
void func_8009B9BC(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5822);

    gameplayFrames = globalCtx->gameplayFrames;
    gSPSegment(NEXT_DISP, 0x08, Gfx_TexScroll(globalCtx->state.gfxCtx, 0, gameplayFrames % 64, 4, 16));

    gDPPipeSync(NEXT_DISP);
    gDPSetEnvColor(NEXT_DISP, 128, 128, 128, 128);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5836);
}
...
void func_8009BAA4(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5850);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5876);
}
...
void func_8009BC44(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5894);
    ...
    sp83 = (sp83 >> 1) + 192;
    gDPPipeSync(NEXT_DISP);
    gDPSetEnvColor(NEXT_DISP, sp83, sp83, sp83, 128);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5930);
}
...
void func_8009C0AC(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 5968);
    ...
    gSPSegment(NEXT_POLY_XLU_DISP, 0x0A,
    ...
    sp7B = (sp7B >> 1) + 192;
    gDPPipeSync(NEXT_DISP);
    gDPSetEnvColor(NEXT_DISP, sp7B, sp7B, sp7B, 128);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6004);
...
void func_8009C3EC(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6042);

    gameplayFrames = globalCtx->gameplayFrames;
    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A338[gSaveContext.nightFlag]));
    gSPSegment(NEXT_DISP, 0x09,
               Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 127 - gameplayFrames % 128, (gameplayFrames * 1) % 128, 32,
                                32, 1, gameplayFrames % 128, (gameplayFrames * 1) % 128, 32, 32));
    gSPSegment(NEXT_POLY_XLU_DISP, 0x0A,
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6076);
}
...
void func_8009C608(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6151);
    ...
    gSPSegment(NEXT_POLY_XLU_DISP, 0x0B,
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6187);
}
...
void func_8009C8B8(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6201);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6232);
}
...
void func_8009CAC0(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6249);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6264);
}
...
void func_8009CC00(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6290);

    gameplayFrames = globalCtx->gameplayFrames;
    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A340[gSaveContext.nightFlag]));
    gSPSegment(NEXT_DISP, 0x09,
               Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 127 - gameplayFrames % 128, (gameplayFrames * 1) % 128, 32,
                                32, 1, gameplayFrames % 128, (gameplayFrames * 1) % 128, 32, 32));
    gSPSegment(NEXT_POLY_XLU_DISP, 0x0A,
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6320);
}
...
void func_8009CF84(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6433);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6449);
}
...
void func_8009D0E8(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6463);

    gameplayFrames = globalCtx->gameplayFrames;
    gSPSegment(NEXT_POLY_XLU_DISP, 0x08,
               Gfx_TexScroll(globalCtx->state.gfxCtx, 127 - (gameplayFrames * 4) % 128, 0, 32, 32));
    gSPSegment(NEXT_DISP, 0x09, Gfx_TexScroll(globalCtx->state.gfxCtx, 0, (gameplayFrames * 5) % 64, 16, 16));
    gSPSegment(NEXT_DISP, 0x0A,
               Gfx_TexScroll(globalCtx->state.gfxCtx, 0, 63 - (gameplayFrames * 2) % 64, 16, 16));
    gSPSegment(
        NEXT_POLY_XLU_DISP, 0x0B,
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6491);
}
...
void func_8009D31C(GlobalContext* globalCtx) {
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6515);

   { s32 pad[2]; }

    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A348[gSaveContext.nightFlag]));
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6528);
}
...
void func_8009D438(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6560);
    ...
    gSPSegment(NEXT_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A358[var]));
    gSPSegment(NEXT_DISP, 0x09, SEGMENTED_TO_VIRTUAL(D_8012A350[var]));
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6581);
}
...
void func_8009D5B4(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6595);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6615);
}
...
void func_8009D758(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6640);

    gameplayFrames = globalCtx->gameplayFrames;
    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A360[gSaveContext.nightFlag]));
    gSPSegment(NEXT_POLY_XLU_DISP, 0x09,
               Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 127 - gameplayFrames % 128, (gameplayFrames * 1) % 128, 32,
                                32, 1, gameplayFrames % 128, (gameplayFrames * 1) % 128, 32, 32));
    gSPSegment(NEXT_DISP, 0x0A,
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6671);
}
...
void func_8009D974(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6752);

    { s32 pad[2]; }

    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A368[gSaveContext.nightFlag]));

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6762);
}
...
void func_8009DA30(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6814);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6866);
}
...
void func_8009DD5C(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6890);

    { s32 pad[2]; }

    gSPSegment(NEXT_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A370[gSaveContext.nightFlag]));
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6903);
}
...
void func_8009DE78(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6917);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 6948);
}
...
void func_8009E0B8(GlobalContext* globalCtx) {
    ...
    gameplayFrames = globalCtx->gameplayFrames;
    gSPSegment(gfxCtx->polyXlu.thaGfx.p++, 0x09,
               Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 127 - gameplayFrames % 128, (gameplayFrames * 1) % 128, 32,
                                32, 1, gameplayFrames % 128, (gameplayFrames * 1) % 128, 32, 32));
    gSPSegment(gfxCtx->polyXlu.thaGfx.p++, 0x08,
               Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 127 - gameplayFrames % 128, (gameplayFrames * 10) % 128, 32,
                                32, 1, gameplayFrames % 128, (gameplayFrames * 10) % 128, 32, 32));

    gDPPipeSync(gfxCtx->polyOpa.thaGfx.p++);
    gDPSetEnvColor(gfxCtx->polyOpa.thaGfx.p++, 128, 128, 128, 128);
    ...
    gSPSegment(gfxCtx->polyOpa.thaGfx.p++, 0x0A, displayListHead);
    gDPPipeSync(displayListHead++);
    gDPSetEnvColor(displayListHead++, 128, 128, 128, spA3);
    gSPEndDisplayList(displayListHead++);

    gSPSegment(gfxCtx->polyXlu.thaGfx.p++, 0x0B, displayListHead);
    gSPSegment(gfxCtx->polyOpa.thaGfx.p++, 0x0B, displayListHead);
    gDPPipeSync(displayListHead++);
    gDPSetEnvColor(displayListHead++, 128, 128, 128, spA0 * 0.1f);
    gSPEndDisplayList(displayListHead);

    gSPSegment(gfxCtx->polyOpa.thaGfx.p++, 0x0C,
...
void func_8009E54C(GlobalContext* globalCtx) {
    ...
    gDPPipeSync(NEXT_DISP);
    gDPSetEnvColor(NEXT_DISP, 255, 255, 255, 128);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7097);
}
...
void func_8009E730(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7123);
    ...
    gSPSegment(NEXT_DISP, 0x0C,
               Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, 0, 0, 64, 32, 1, 0, var, 64, 32));

    gDPPipeSync(NEXT_DISP);
    gDPSetEnvColor(NEXT_DISP, 128, 128, 128, 128);

    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A378[gSaveContext.nightFlag]));

    { s32 pad[2]; } // Necessary to match stack usage

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7147);
}
...
void func_8009E8C0(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7161);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7192);
}
...
void func_8009EAD8(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7206);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7260);
}
...
void func_8009EE44(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7274);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7309);
}
...
void func_8009F074(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7323);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7339);
}
...
void func_8009F1B4(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7363);

    { s32 pad[2]; }

    gSPSegment(NEXT_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A380[gSaveContext.nightFlag]));

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7371);
}
...
void func_8009F270(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7385);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7409);
}
...
void func_8009F40C(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7423);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7443);
}
...
void func_8009F5D4(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7461);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7495);
}
...
void func_8009F7D4(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7512);
    ...
    gDPPipeSync(NEXT_DISP);
    gDPSetEnvColor(NEXT_DISP, sp6F, sp6E, 255, 128);

    gDPPipeSync(NEXT_POLY_XLU_DISP);
    gDPSetEnvColor(NEXT_POLY_XLU_DISP, 128, 128, 128, 128);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7530);
}
...
void func_8009F9D0(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7555);
    ...
    gSPSegment(NEXT_POLY_XLU_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A388[gSaveContext.nightFlag]));

    { s32 pad[2]; } // Necessary to match stack usage

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7578);
}
...
void func_8009FB74(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7602);

    { s32 pad[2]; }
    gSPSegment(NEXT_DISP, 0x08, SEGMENTED_TO_VIRTUAL(D_8012A390[gSaveContext.nightFlag]));
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7615);
}
...
void func_8009FC90(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7630);
    ...
    gDPPipeSync(NEXT_DISP);
    gDPSetEnvColor(NEXT_DISP, 128, 128, 128, 64);

    gDPPipeSync(NEXT_POLY_XLU_DISP);
    gDPSetEnvColor(NEXT_POLY_XLU_DISP, 128, 128, 128, 64);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7653);
}
...
void func_8009FE58(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7712);
    ...
    gSPSegment(NEXT_DISP, 0x0D, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_scene_table.c", 7809));

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7811);
}
#else
s16 D_8012A39C = 538;
s16 D_8012A3A0 = 4272;
...
void func_800A0334(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7825);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7852);
}
...
void func_800A059C(GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7893);
    ...
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 7910);
}
...
void Scene_Draw(GlobalContext* globalCtx) {
    ...
    if (HREG(80) == 17) {
        ...
        OPEN_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 8104);
        ...
        CLOSE_DISP(globalCtx->state.gfxCtx, "../z_scene_table.c", 8109);
