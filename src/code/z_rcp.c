...
void func_80093848(GraphicsContext* gfxCtx) {
    ...
    OPEN_DISP(gfxCtx, "../z_rcp.c", 1293);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x3A]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1297);
}

void func_800938B4(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1309);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x39]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1313);
}

void func_80093920(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1325);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x32]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1329);
}

void func_8009398C(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1341);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x33]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1345);
}

void func_800939F8(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1357);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x34]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1361);
}

void func_80093A64(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1373);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x35]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1377);
}

void func_80093AD0(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1389);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x36]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1393);
}

void func_80093B3C(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1405);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x37]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1409);
}

void func_80093BA8(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1421);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x1A]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1425);
}

void func_80093C14(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1439);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x19]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1443);
}
...
void func_80093C80(GlobalContext* globalCtx) {
    ...
    if (globalCtx->roomCtx.curRoom.unk_03 == 3) {
        OPEN_DISP(gfxCtx, "../z_rcp.c", 1460);

        gDPSetColorDither(NEXT_DISP, G_CD_DISABLE);

        CLOSE_DISP(gfxCtx, "../z_rcp.c", 1462);
    }
}

void func_80093D18(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1475);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x19]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1479);
}

void func_80093D84(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1491);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x19]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1495);
}

void func_80093DF0(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1507);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x1F]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1511);
}

void func_80093E5C(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1523);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x20]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1527);
}

void func_80093EC8(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1539);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x21]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1543);
}
...
void func_80093F7C(GraphicsContext* gfxCtx) {
    ...
    OPEN_DISP(gfxCtx, "../z_rcp.c", 1569);

    SET_NOW_DISP(func_80093F58(NOW_DISP));

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1573);
}

void func_80093FD8(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1585);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x23]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1589);
}

void func_80094044(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1601);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x2C]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1605);
}

void func_800940B0(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1617);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x24]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1621);
}
...
void func_80094140(GraphicsContext* gfxCtx) {
    ...
    OPEN_DISP(gfxCtx, "../z_rcp.c", 1640);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x1C]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1644);
}

void func_800941AC(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1651);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x2B]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1655);
}

void func_80094218(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1670);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x2D]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1674);
}

void func_80094284(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1681);

    gSPDisplayList(NEXT_OVERLAY_DISP, &sSetupDL[6 * 0x2E]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1685);
}

void func_800942F0(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1700);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x26]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1704);
}

void func_8009435C(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1722);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x04]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1726);
}

void func_800943C8(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1758);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x25]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1762);
}

void func_80094434(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1775);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x02]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1779);
}
...
void func_800944C4(GraphicsContext* gfxCtx) {
    ...
    OPEN_DISP(gfxCtx, "../z_rcp.c", 1799);

    SET_NOW_DISP(func_800944A0(NOW_DISP));

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1801);
}

void func_80094520(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1809);

    SET_NOW_OVERLAY_DISP(func_800944A0(NOW_OVERLAY_DISP));

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1811);
}
...
void func_800945A0(GraphicsContext* gfxCtx) {
    ...
    OPEN_DISP(gfxCtx, "../z_rcp.c", 1837);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x28]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1841);
}

void func_8009460C(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1853);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x29]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1857);
}

void func_80094678(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1869);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x2F]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1873);
}
...
void func_800949A8(GraphicsContext* gfxCtx) {
    ...
    OPEN_DISP(gfxCtx, "../z_rcp.c", 1953);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x2A]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1957);
}

void func_80094A14(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1964);

    gSPDisplayList(NEXT_OVERLAY_DISP, &sSetupDL[6 * 0x2A]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1968);
}

void func_80094A80(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 1992);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x30]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 1996);
}

void func_80094AEC(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 2008);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x31]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 2012);
}

void func_80094B58(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 2024);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x1B]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 2028);
}

void func_80094BC4(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 2040);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x3C]);
    gDPSetColorDither(NEXT_POLY_XLU_DISP, G_CD_DISABLE);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 2043);
}

void func_80094C50(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 2056);

    gSPDisplayList(NEXT_POLY_XLU_DISP, &sSetupDL[6 * 0x3D]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 2058);
}

void func_80094CBC(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 2086);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x38]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 2090);
}
...
void func_80094D4C(GraphicsContext* gfxCtx) {
    ...
    OPEN_DISP(gfxCtx, "../z_rcp.c", 2112);

    gSPDisplayList(NEXT_DISP, &sSetupDL[6 * 0x3B]);

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 2116);
}
...
void func_80095248(GraphicsContext* gfxCtx, u8 r, u8 g, u8 b) {
    ...
    OPEN_DISP(gfxCtx, "../z_rcp.c", 2386);

    gSPDisplayList(NEXT_DISP, sFillSetupDL);
    gSPDisplayList(NEXT_POLY_XLU_DISP, sFillSetupDL);
    gSPDisplayList(NEXT_OVERLAY_DISP, sFillSetupDL);

    gDPSetScissorFrac(NEXT_DISP, G_SC_NON_INTERLACE, 0, 0, gScreenWidth * 4.0f, gScreenHeight * 4.0f);
    gDPSetScissorFrac(NEXT_POLY_XLU_DISP, G_SC_NON_INTERLACE, 0, 0, gScreenWidth * 4.0f, gScreenHeight * 4.0f);
    gDPSetScissorFrac(NEXT_OVERLAY_DISP, G_SC_NON_INTERLACE, 0, 0, gScreenWidth * 4.0f, gScreenHeight * 4.0f);

    gDPSetColorImage(NEXT_DISP, G_IM_FMT_RGBA, G_IM_SIZ_16b, gScreenWidth, gfxCtx->FrameBufferP);
    gDPSetColorImage(NEXT_DISP, G_IM_FMT_RGBA, G_IM_SIZ_16b, gScreenWidth, gfxCtx->FrameBufferP);
    gDPSetColorImage(NEXT_POLY_XLU_DISP, G_IM_FMT_RGBA, G_IM_SIZ_16b, gScreenWidth, gfxCtx->FrameBufferP);
    gDPSetColorImage(NEXT_OVERLAY_DISP, G_IM_FMT_RGBA, G_IM_SIZ_16b, gScreenWidth, gfxCtx->FrameBufferP);

    gDPSetDepthImage(NEXT_DISP, gZBuffer);
    gDPSetDepthImage(NEXT_POLY_XLU_DISP, gZBuffer);
    gDPSetDepthImage(NEXT_OVERLAY_DISP, gZBuffer);
    ...
    if ((R_PAUSE_MENU_MODE < 2) && (gTrnsnUnkState < 2)) {
        ...
        gDPSetColorImage(NEXT_DISP, G_IM_FMT_RGBA, G_IM_SIZ_16b, gScreenWidth, gZBuffer);
        gDPSetCycleType(NEXT_DISP, G_CYC_FILL);
        gDPSetRenderMode(NEXT_DISP, G_RM_NOOP, G_RM_NOOP2);
        gDPSetFillColor(NEXT_DISP,
                        (GPACK_RGBA5551(255, 255, 240, 0) << 16) | GPACK_RGBA5551(255, 255, 240, 0));
        gDPFillRectangle(NEXT_DISP, 0, ret, gScreenWidth - 1, gScreenHeight - ret - 1);
        gDPPipeSync(NEXT_DISP);

        gDPSetColorImage(NEXT_DISP, G_IM_FMT_RGBA, G_IM_SIZ_16b, gScreenWidth, gfxCtx->FrameBufferP);
        gDPSetCycleType(NEXT_DISP, G_CYC_FILL);
        gDPSetRenderMode(NEXT_DISP, G_RM_NOOP, G_RM_NOOP2);
        gDPSetFillColor(NEXT_DISP, (GPACK_RGBA5551(r, g, b, 1) << 16) | GPACK_RGBA5551(r, g, b, 1));
        gDPFillRectangle(NEXT_DISP, 0, ret, gScreenWidth - 1, gScreenHeight - ret - 1);
        gDPPipeSync(NEXT_DISP);
        ...
        if (ret > 0) {
            ...
            gDPSetFillColor(NEXT_OVERLAY_DISP, (GPACK_RGBA5551(r, g, b, 1) << 16) | GPACK_RGBA5551(r, g, b, 1));
            gDPFillRectangle(NEXT_OVERLAY_DISP, 0, 0, gScreenWidth - 1, ret - 1);
            gDPFillRectangle(NEXT_OVERLAY_DISP, 0, gScreenHeight - ret, gScreenWidth - 1, gScreenHeight - 1);
            gDPPipeSync(NEXT_OVERLAY_DISP);
        }
    }

    CLOSE_DISP(gfxCtx, "../z_rcp.c", 2497);
}

void func_80095974(GraphicsContext* gfxCtx) {

    OPEN_DISP(gfxCtx, "../z_rcp.c", 2503);
    ...
    CLOSE_DISP(gfxCtx, "../z_rcp.c", 2513);
}
