...
void ViMode_LogPrint(OSViMode* osViMode) {
    ...
    LOG_HEX32("osViMode->comRegs.ctrl", osViMode->comRegs.ctrl, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->comRegs.width", osViMode->comRegs.width, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->comRegs.burst", osViMode->comRegs.burst, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->comRegs.vSync", osViMode->comRegs.vSync, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->comRegs.hSync", osViMode->comRegs.hSync, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->comRegs.leap", osViMode->comRegs.leap, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->comRegs.hStart", osViMode->comRegs.hStart, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->comRegs.xScale", osViMode->comRegs.xScale, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[0].vStart", osViMode->fldRegs[0].vStart, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[0].vBurst", osViMode->fldRegs[0].vBurst, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[0].origin", osViMode->fldRegs[0].origin, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[0].yScale", osViMode->fldRegs[0].yScale, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[0].vIntr", osViMode->fldRegs[0].vIntr, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[1].vStart", osViMode->fldRegs[1].vStart, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[1].vBurst", osViMode->fldRegs[1].vBurst, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[1].origin", osViMode->fldRegs[1].origin, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[1].yScale", osViMode->fldRegs[1].yScale, "../z_vimode.c", __LINE__);
    LOG_HEX32("osViMode->fldRegs[1].vIntr", osViMode->fldRegs[1].vIntr, "../z_vimode.c", __LINE__);
}
