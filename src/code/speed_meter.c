...
void SpeedMeter_DrawTimeEntries(SpeedMeter* this, GraphicsContext* gfxCtx) {
    ...
    OPEN_DISP(gfxCtx, "../speed_meter.c", 225);
    ...
    SET_NOW_OVERLAY_DISP(gfx);
    CLOSE_DISP(gfxCtx, "../speed_meter.c", 276);
}
...
void SpeedMeter_DrawAllocEntry(SpeedMeterAllocEntry* this, GraphicsContext* gfxCtx) {
    ...
    if (this->maxval == 0) {
        ...
        OPEN_DISP(gfxCtx, "../speed_meter.c", 318);
        ...
        SET_NOW_OVERLAY_DISP(gfx);
        CLOSE_DISP(gfxCtx, "../speed_meter.c", 339);
    }
}
