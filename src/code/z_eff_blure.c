...
void EffectBlure_AddVertex(EffectBlure* this, Vec3f* p1, Vec3f* p2) {
    ...
    if (this != NULL) {
        ...
        if (numElements >= 16) {
            ...
            PRINTF("Blure vertex addition processing: Table over %d\n", numElements);
            return;
        }
...
void EffectBlure_AddSpace(EffectBlure* this) {
    ...
    if (this != NULL) {
        ...
        if (numElements >= 16) {
            ...
            PRINTF("Blure space addition processing: Table over %d %d\n", numElements);
            return;
        }
...
void EffectBlure_DrawElemNoInterpolation(EffectBlure* this, EffectBlureElement* elem, s32 index,
    ...
    if (vtx == NULL) {
        ...
        PRINTF("z_eff_blure.c::EffectBlure_DrawElemNoInterpolation() Vertice cannot be secured\n");
    } else {
        vtx[0].v = baseVtx;
        vtx[1].v = baseVtx;
        vtx[2].v = baseVtx;
...
void EffectBlure_DrawElemHermiteInterpolation(EffectBlure* this, EffectBlureElement* elem, s32 index,
    ...
    if (vtx == NULL) {
        // "Vertices cannot be secured."
        PRINTF("z_eff_blure.c::EffectBlure_DrawElemHermiteInterpolation() Vertices cannot be secured\n");
    } else {
            ...
            if (this->flags & 4) {
                ...
                if (fabsf(scale) > 0.0005f) {
                    ...
                    if (mtx == NULL) {
                        ...
                        PRINTF("EffectBlure_DrawSimpleVertices() Forced termination because a matrix cannot be taken\n");
                        break;
                    }
...
void EffectBlure_DrawSimple(EffectBlure* this2, GraphicsContext* gfxCtx) {
    ...
    if (this->numElements >= 2) {
        ...
        if (vtx == NULL) {
            ...
            PRINTF("Vertices cannot be secured. Forced termination\n");
            return;
        }
    ...
    if (this->numElements != 0) {
        if (this->flags == 0) {
            ...
            if (vtx == NULL) {
                ...
                PRINTF("Blure display: Vertex table could not be secured\n");
            } else {
                j = 0;
                for (i = 0; i < this->numElements; i++) {
                    elem = &this->elements[i];
