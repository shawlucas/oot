...
void func_800C4344(GameState* gameState) {
    ...
    if (HREG(80) == 0xC) {
        ...
        HREG(85) = selectedInput->rel.x;
        HREG(86) = selectedInput->rel.y;
        HREG(87) = selectedInput->rel.x;
        HREG(88) = selectedInput->rel.y;
        HREG(89) = selectedInput->cur.x;
        HREG(90) = selectedInput->cur.y;
