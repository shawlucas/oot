...
u32 func_80091738(PlayState* play, u8* segment, SkelAnime* skelAnime) {
    ...
    DmaMgr_RequestSyncDebug(ptr, gObjectTable[OBJECT_GAMEPLAY_KEEP].vromStart, size, "../z_player_lib.c", __LINE__);
    ...
    DmaMgr_RequestSyncDebug(ptr, gObjectTable[linkObjectId].vromStart, size, "../z_player_lib.c", __LINE__);
