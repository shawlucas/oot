...
void Gfx_DrawDListOpa(PlayState* play, Gfx* dlist) {
    ...
    gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(play->state.gfxCtx, "../z_cheap_proc.c", __LINE__),
...
void Gfx_DrawDListXlu(PlayState* play, Gfx* dlist) {
    ...
    gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(play->state.gfxCtx, "../z_cheap_proc.c", __LINE__),
              G_MTX_MODELVIEW | G_MTX_LOAD);
