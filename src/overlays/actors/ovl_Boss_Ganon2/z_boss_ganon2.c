...
void BossGanon2_SetObjectSegment(BossGanon2* this, GlobalContext* globalCtx, s32 objectId, u8 setRSPSegment) {
    ...
    if (setRSPSegment) {
        OPEN_DISPS(globalCtx->state.gfxCtx, "../z_boss_ganon2.c", __LINE__);
        ...
        CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_boss_ganon2.c", __LINE__);
    }
}
...
void func_80903F38(BossGanon2* this, GlobalContext* globalCtx) {
    ...
    if (D_80910638 >= 4) {
        ...
        gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_boss_ganon2.c", __LINE__),
...
void BossGanon2_PostLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if ((limbIndex == 7) || (limbIndex == 13)) {
        ...
        gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_boss_ganon2.c", __LINE__),
                  G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
...
void BossGanon2_DrawShadowTexture(void* shadowTexture, BossGanon2* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_boss_ganon2.c", __LINE__);
    ...
    CLOSE_DISPS(gfxCtx, "../z_boss_ganon2.c", __LINE__);
}
