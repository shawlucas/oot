...
void ObjComb_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_obj_comb.c", 369);
    ...
    gSPMatrix(NEXT_DISP, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_obj_comb.c", 394),
              G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);

    gSPDisplayList(NEXT_DISP, D_050095B0);

    func_800628A4(0, &this->collider);
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_obj_comb.c", 402);
}
