...
void MagicFire_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->action > 0) {
        OPEN_DISPS(globalCtx->state.gfxCtx, "../z_magic_fire.c", __LINE__);
        ...
        gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_magic_fire.c", __LINE__),
        ...
        CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_magic_fire.c", __LINE__);
