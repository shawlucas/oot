...
void DoorWarp1_DrawBlueCrystal(DoorWarp1* this, GlobalContext* globalCtx) {
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_door_warp1.c", __LINE__);
...
void DoorWarp1_DrawWarp(DoorWarp1* this, GlobalContext* globalCtx) {
    ...
    gSPSegment(POLY_XLU_DISP++, 0x0A, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_door_warp1.c", __LINE__));
    Matrix_Push();
    ...
    gSPSegment(POLY_XLU_DISP++, 0x09, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_door_warp1.c", __LINE__));
