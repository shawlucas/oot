...
void EnSyatekiItm_Init(Actor* thisx, PlayState* play2) {
    ...
    if (this->man == NULL) {
        // "Spawn error"
        osSyncPrintf(VT_FGCOL(GREEN) "☆☆☆☆☆ Shooting Gallery: Spawn Error ☆☆☆☆ \n" VT_RST);
    ...
    for (i = 0; i < 10; i++) {
        ...
        if (this->markers[i] == NULL) {
            // "Second spawn error"
            osSyncPrintf(VT_FGCOL(YELLOW) "☆☆☆☆☆ Shooting Gallery: Second Spawn Error ☆☆☆☆ \n" VT_RST);
            Actor_Kill(&this->actor);
            return;
        }
    ...
    if (this->timer == 0) {
        ...
        for (i = 0; i < this->numTargets; i++) {
            ...
            if (this->targets[i] == NULL) {
                // "Rupee spawn error"
                osSyncPrintf(VT_FGCOL(GREEN) "☆☆☆☆☆ Shooting Gallery: Rupee Spawn Error ☆☆☆☆ \n" VT_RST);
                Actor_Kill(&this->actor);
                return;
            }
...
void EnSyatekiItm_EndGame(EnSyatekiItm* this, PlayState* play) {
    ...
    if (this->signal == ENSYATEKI_START) {
        ...
        osSyncPrintf(VT_FGCOL(RED) "☆☆☆☆☆ 1 frame attack and defense！ ☆☆☆☆ \n" VT_RST);
        osSyncPrintf(VT_FGCOL(RED) "☆☆☆☆☆ 1 frame attack and defense！ ☆☆☆☆ \n" VT_RST);
        osSyncPrintf(VT_FGCOL(RED) "☆☆☆☆☆ 1 frame attack and defense！ ☆☆☆☆ \n" VT_RST);
        osSyncPrintf(VT_FGCOL(RED) "☆☆☆☆☆ 1 frame attack and defense！ ☆☆☆☆ \n" VT_RST);
        osSyncPrintf(VT_FGCOL(RED) "☆☆☆☆☆ 1 frame attack and defense！ ☆☆☆☆ \n" VT_RST);
