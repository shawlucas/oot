...
void func_80AF9C70(u8* shadowTexture, Player* player, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_en_sda.c", __LINE__);
    ...
    gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_sda.c", __LINE__),
    ...
    CLOSE_DISPS(gfxCtx, "../z_en_sda.c", __LINE__);
}
