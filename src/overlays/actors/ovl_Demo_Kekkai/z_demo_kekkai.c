...
void DemoKekkai_DrawTrialBarrier(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    if (this->orbScale != 0.0f) {
        ...
        OPEN_DISPS(globalCtx->state.gfxCtx, "../z_demo_kekkai.c", __LINE__);
        ...
        Matrix_Translate(0.0f, -1200.0f, 0.0f, MTXMODE_APPLY);
        gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_demo_kekkai.c", __LINE__),
        ...
        CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_demo_kekkai.c", __LINE__);
    }
}
