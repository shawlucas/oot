...
void BgSpot17Funen_Init(Actor* thisx, GlobalContext* globalCtx) {
    ...
    osSyncPrintf("spot17 obj. 噴煙 (params 0x%04X)\n", this->actor.params);
}
...
void func_808B7478(Actor* thisx, GlobalContext* globalCtx) {
    OPEN_DISPS(globalCtx->state.gfxCtx, "../z_bg_spot17_funen.c", __LINE__);
    ...
    gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_bg_spot17_funen.c", __LINE__),
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_bg_spot17_funen.c", __LINE__);
}
