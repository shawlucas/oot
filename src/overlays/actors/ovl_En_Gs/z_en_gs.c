...
void EnGs_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (!(this->unk_19E & 8)) {
        OPEN_DISPS(globalCtx->state.gfxCtx, "../z_en_gs.c", __LINE__);
        ...
        gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_gs.c", __LINE__),
        ...
        if (this->unk_19E & 2) {
            ...
            gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_gs.c", __LINE__),
                      G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
            gSPSegment(
                POLY_XLU_DISP++, 0x08,
        ...
        CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_en_gs.c", __LINE__);
    }
}
