...
void func_80AEC320(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if ((gSaveContext.memory.information.infTable[20] & 0x80) && (!(gSaveContext.memory.information.infTable[20] & 1)) &&
...
void func_80AED44C(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if ((gSaveContext.memory.information.infTable[20] & 2) && (!(gSaveContext.memory.information.infTable[20] & 0x20)) &&
        (!(gSaveContext.memory.information.infTable[20] & 1)) && (!(gSaveContext.memory.information.infTable[20] & 0x80))) {
        if (!func_80AEB020(this, globalCtx)) {
            func_80AEB264(this, &D_060097B8, 0, 0, 0);
            actorRoom = thisx->room;
            this->action = 22;
...
void func_80AEF890(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if ((gSaveContext.gameInfo.sceneSetupIndex < 4) && (func_80AEAF38(globalCtx))) {
        curRoomNum = globalCtx->roomCtx.curRoom.num;
        gSaveContext.memory.information.infTable[20] |= 0x20;
...
void func_80AEFC54(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if ((gSaveContext.memory.information.infTable[20] & 0x20) && (!(gSaveContext.memory.information.infTable[20] & 0x40))) {
        func_80AEB264(this, &D_060097B8, 0, 0, 0);
        this->action = 41;
...
void func_80AEFD38(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if ((gSaveContext.memory.information.eventChkInf[3] & 0x80) && (gSaveContext.linkAge == 1)) {
        func_80AEB264(this, &D_060097B8, 0, 0, 0);
        thisx->flags &= ~0x10;
        this->action = 44;
        this->drawConfig = 1;
...
void func_80AEFF94(EnRu1* this, GlobalContext* globalCtx) {
    ...
    if ((gSaveContext.memory.information.infTable[20] & 2) && (gSaveContext.memory.information.infTable[20] & 1) && (!(gSaveContext.memory.information.infTable[20] & 0x20)) &&
