...
void func_808C0EEC(BgZg* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISP(gfxCtx, "../z_bg_zg.c", 311);

    func_80093D18(gfxCtx);
    gSPMatrix(NEXT_DISP, Matrix_NewMtx(gfxCtx, "../z_bg_zg.c", 315),
              G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);

    gSPDisplayList(NEXT_DISP, D_06001080);
    CLOSE_DISP(gfxCtx, "../z_bg_zg.c", 320);
}
