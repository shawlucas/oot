...
void func_808C0EEC(BgZg* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(localGfxCtx, "../z_bg_zg.c", __LINE__);

    func_80093D18(localGfxCtx);
    gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(localGfxCtx, "../z_bg_zg.c", __LINE__),
              G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    gSPDisplayList(POLY_OPA_DISP++, gTowerCollapseBarsDL);

    CLOSE_DISPS(localGfxCtx, "../z_bg_zg.c", __LINE__);
}
