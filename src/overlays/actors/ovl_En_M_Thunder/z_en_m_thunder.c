...
void EnMThunder_Draw(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    OPEN_DISPS(globalCtx->state.gfxCtx, "../z_en_m_thunder.c", __LINE__);
    func_80093D84(globalCtx->state.gfxCtx);
    Matrix_Scale(0.02f, 0.02f, 0.02f, MTXMODE_APPLY);
    gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_m_thunder.c", __LINE__),
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_en_m_thunder.c", __LINE__);
}
