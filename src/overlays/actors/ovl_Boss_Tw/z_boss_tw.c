...
void BossTw_PostLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    switch (limbIndex) {
        case 21:
            ...
            if (this->unk_5F8 != 0) {
                gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_boss_tw.c", __LINE__),
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_boss_tw.c", __LINE__);
}
...
void BossTw_DrawEffects(GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_boss_tw.c", __LINE__);
    ...
    for (i = 0; i < ARRAY_COUNT(sTwEffects); i++) {
        if (currentEffect->type == 1) {
            ...
            gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(gfxCtx, "../z_boss_tw.c", __LINE__),
                      G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    ...
    CLOSE_DISPS(gfxCtx, "../z_boss_tw.c", __LINE__);
}
