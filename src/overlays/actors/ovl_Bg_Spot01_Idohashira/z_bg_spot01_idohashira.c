...
void func_808AB700(BgSpot01Idohashira* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(localGfxCtx, "../z_bg_spot01_idohashira.c", __LINE__);

    func_80093D18(localGfxCtx);

    gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(localGfxCtx, "../z_bg_spot01_idohashira.c", __LINE__),
              G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    func_808AAF34(this, globalCtx);
    gSPDisplayList(POLY_OPA_DISP++, gKakarikoWellArchDL);

    CLOSE_DISPS(localGfxCtx, "../z_bg_spot01_idohashira.c", __LINE__);
}
