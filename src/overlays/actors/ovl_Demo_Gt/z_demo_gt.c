...
void DemoGt_Draw1(DemoGt* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_demo_gt_part1.c", __LINE__);
    ...
    CLOSE_DISPS(gfxCtx, "../z_demo_gt_part1.c", __LINE__);
}
...
void DemoGt_Draw2(DemoGt* this, GlobalContext* globalCtx) {
    ...
    gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(gfxCtx, "../z_demo_gt_part2.c", __LINE__),
              G_MTX_PUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    gSPDisplayList(POLY_OPA_DISP++, gTowerCollapseCsCollapsedStructureInnerDL);
    gSPPopMatrix(POLY_OPA_DISP++, G_MTX_MODELVIEW);

    CLOSE_DISPS(gfxCtx, "../z_demo_gt_part2.c", __LINE__);
}
...
void DemoGt_Draw3(DemoGt* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_demo_gt_part3.c", __LINE__);

    func_80093D18(gfxCtx);
    gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(gfxCtx, "../z_demo_gt_part3.c", __LINE__),
              G_MTX_PUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    gSPDisplayList(POLY_OPA_DISP++, gTowerCollapseCsCollapsedStructureOuterDL);
    gSPPopMatrix(POLY_OPA_DISP++, G_MTX_MODELVIEW);

    CLOSE_DISPS(gfxCtx, "../z_demo_gt_part3.c", __LINE__);
}
...
void DemoGt_Draw4(DemoGt* this, GlobalContext* globalCtx2) {
    ...
    if (frames < 301) {
        ...
        OPEN_DISPS(gfxCtx, "../z_demo_gt_part4_1.c", __LINE__);
        ...
        CLOSE_DISPS(gfxCtx, "../z_demo_gt_part4_1.c", __LINE__);
    }
}
...
void DemoGt_Draw5(DemoGt* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_demo_gt_part4_2.c", __LINE__);
    ...
    CLOSE_DISPS(gfxCtx, "../z_demo_gt_part4_2.c", __LINE__);
}
...
void DemoGt_Draw6(DemoGt* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_demo_gt_part4_3.c", __LINE__);
    ...
    CLOSE_DISPS(gfxCtx, "../z_demo_gt_part4_3.c", __LINE__);
}
...
void DemoGt_Draw7(DemoGt* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_demo_gt_part5.c", __LINE__);
    ...
    CLOSE_DISPS(gfxCtx, "../z_demo_gt_part5.c", __LINE__);
}
...
void DemoGt_Draw8(DemoGt* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_demo_gt_part6.c", __LINE__);
    ...
    CLOSE_DISPS(gfxCtx, "../z_demo_gt_part6.c", __LINE__);
}
