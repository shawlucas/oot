...
void ObjTimeblock_Draw(Actor* thisx, GlobalContext* globalCtx) {
    if (((ObjTimeblock*)thisx)->isVisible) {
        ...
        OPEN_DISPS(globalCtx->state.gfxCtx, "../z_obj_timeblock.c", __LINE__);

        func_80093D18(globalCtx->state.gfxCtx);
        gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_obj_timeblock.c", __LINE__),
        ...
        CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_obj_timeblock.c", __LINE__);
    }
}
