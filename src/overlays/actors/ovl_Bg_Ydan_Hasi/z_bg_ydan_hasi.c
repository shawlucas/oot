...
void BgYdanHasi_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_bg_ydan_hasi.c", 577);
    ...
    gSPMatrix(NEXT_POLY_XLU_DISP, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_bg_ydan_hasi.c", 592),
              G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    gSPDisplayList(NEXT_POLY_XLU_DISP, &D_06005DE0);
    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_bg_ydan_hasi.c", 597);
}
