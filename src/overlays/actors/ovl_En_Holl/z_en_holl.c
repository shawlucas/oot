...
void EnHoll_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (this->planeAlpha != 0) {
        OPEN_DISPS(globalCtx->state.gfxCtx, "../z_en_holl.c", __LINE__);
        ...
        gSPMatrix(gfxP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_holl.c", __LINE__),
        ...
        CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_en_holl.c", __LINE__);
    }
}
