...
s32 func_80A3AAA8(GlobalContext* globalCtx, EnGirlA* this) {
    ...
    if (gSaveContext.memory.privatef.rupees < this->unk_1C8) {
        return 4;
    }
    return 1;
}
...
s32 func_80A3AF30(GlobalContext* globalCtx, EnGirlA* this) {
    if ((gBitFlags[2] & gSaveContext.memory.table.equipment) && !(gBitFlags[3] & gSaveContext.memory.table.equipment)) {
        return 2;
    }
    if (gSaveContext.memory.privatef.rupees < this->unk_1C8) {
        return 4;
...
s32 func_80A3AFC4(GlobalContext* globalCtx, EnGirlA* this) {
    if (gBitFlags[5] & gSaveContext.memory.table.equipment) {
        return 2;
    }
    if (gSaveContext.memory.privatef.rupees < this->unk_1C8) {
        return 4;
...
s32 func_80A3B040(GlobalContext* globalCtx, EnGirlA* this) {
    if (gBitFlags[4] & gSaveContext.memory.table.equipment) {
        return 2;
    }
    if (gSaveContext.memory.privatef.rupees < this->unk_1C8) {
        return 4;
...
s32 func_80A3B0BC(GlobalContext* globalCtx, EnGirlA* this) {
    ...
    if (gBitFlags[9] & gSaveContext.memory.table.equipment) {
        return 2;
    }
    if (gSaveContext.memory.privatef.rupees < this->unk_1C8) {
        return 4;
...
s32 func_80A3B160(GlobalContext* globalCtx, EnGirlA* this) {
    ...
    if (gBitFlags[10] & gSaveContext.memory.table.equipment) {
        return 2;
    }
    if (gSaveContext.memory.privatef.rupees < this->unk_1C8) {
        return 4;
...
s32 func_80A3B204(GlobalContext* globalCtx, EnGirlA* this) {
    if (gSaveContext.memory.privatef.healthCapacity == gSaveContext.memory.privatef.health) {
        return 2;
    }
    if (gSaveContext.memory.privatef.rupees < this->unk_1C8) {
        return 4;
