...
void EnFloormas_PostLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx, Gfx** gfx) {
    if (limbIndex == 2) {
        ...
        gSPMatrix((*gfx)++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_floormas.c", __LINE__), G_MTX_LOAD);
...
void EnFloormas_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(globalCtx->state.gfxCtx, "../z_en_floormas.c", __LINE__);
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_en_floormas.c", __LINE__);
}
