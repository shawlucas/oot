...
EnInAnimation D_80A7B878[] = {
    { 0x06001CC0, 1.0f, 0x00, 0.0f },
    { 0x06001CC0, 1.0f, 0x00, -10.0f },
    { 0x06013C6C, 1.0f, 0x00, 0.0f },
    { 0x06013C6C, 1.0f, 0x00, -10.0f },
    { 0x06000CB0, 1.0f, 0x00, 0.0f },
    { 0x060003B4, 1.0f, 0x00, -10.0f },
    { 0x06001BE0, 1.0f, 0x00, 0.0f },
    { 0x06013D60, 1.0f, 0x00, 0.0f },
    { 0x0601431C, 1.0f, 0x00, 0.0f },
    { 0x06014CA8, 1.0f, 0x00, 0.0f },
};

AnimationHeader* D_80A7B918[] = { 0x060151C8, 0x06015DF0, 0x06016B3C, 0x06015814, 0x0601646C, 0x060175D0, 0x06017B58, 0x06018C38 };
