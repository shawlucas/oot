...
void EnFhgFire_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(globalCtx->state.gfxCtx, "../z_en_fhg_fire.c", __LINE__);
    ...
    if (this->actor.params == FHGFIRE_LIGHTNING_BURST) {
        ...
        gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_fhg_fire.c", __LINE__),
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_en_fhg_fire.c", __LINE__);
}
