...
void EnDyExtra_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_en_dy_extra.c", __LINE__);
    ...
    gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_dy_extra.c", __LINE__),
    ...
    CLOSE_DISPS(gfxCtx, "../z_en_dy_extra.c", __LINE__);
}
