...
s32 MagicWind_OverrideLimbDraw(GlobalContext* globalCtx, SkelAnimeCurve* skelCurve, s32 limbIndex, void* thisx) {
    ...
    OPEN_DISPS(globalCtx->state.gfxCtx, "../z_magic_wind.c", __LINE__);
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_magic_wind.c", __LINE__);
...
void MagicWind_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(gfxCtx, "../z_magic_wind.c", __LINE__);
    ...
    CLOSE_DISPS(gfxCtx, "../z_magic_wind.c", __LINE__);
}
