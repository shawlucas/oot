...
void func_80AF321C(EnRu2* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(globalCtx->state.gfxCtx, "../z_en_ru2_inKenjyanomaDemo02.c", __LINE__);
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_en_ru2_inKenjyanomaDemo02.c", __LINE__);
}
...
void func_80AF3F20(EnRu2* this, GlobalContext* globalCtx) {
    ...
    OPEN_DISPS(globalCtx->state.gfxCtx, "../z_en_ru2.c", __LINE__);
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_en_ru2.c", __LINE__);
}
