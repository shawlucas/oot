...
void BgMizuMovebg_Draw(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_bg_mizu_movebg.c", __LINE__),
    ...
    CLOSE_DISPS(globalCtx->state.gfxCtx, "../z_bg_mizu_movebg.c", __LINE__);
}
