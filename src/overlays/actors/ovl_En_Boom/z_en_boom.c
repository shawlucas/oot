...
static InitChainEntry sInitChain[] = {
    ICHAIN_S8(naviRange, 5, ICHAIN_CONTINUE),
...
void EnBoom_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_en_boom.c", 567);
    ...
    gSPMatrix(NEXT_DISP, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_en_boom.c", 601),
              G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    gSPDisplayList(NEXT_DISP, D_0400C808);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_en_boom.c", 604);
}
