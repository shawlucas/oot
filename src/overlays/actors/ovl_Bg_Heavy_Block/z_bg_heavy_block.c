...
void BgHeavyBlock_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    OPEN_DISP(globalCtx->state.gfxCtx, "../z_bg_heavy_block.c", 904);
    ...
    gSPMatrix(NEXT_DISP, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_bg_heavy_block.c", 931),
              G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
    gSPDisplayList(NEXT_DISP, D_060013C0);

    CLOSE_DISP(globalCtx->state.gfxCtx, "../z_bg_heavy_block.c", 935);
}
