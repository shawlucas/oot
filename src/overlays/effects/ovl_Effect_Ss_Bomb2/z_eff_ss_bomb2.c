...
void EffectSsBomb2_DrawFade(GlobalContext* globalCtx, u32 index, EffectSs* this) {
    ...
    if (mtx != NULL) {
        ...
        gDPSetPrimColor(gfxCtx->polyXlu.thaGfx.p++, 0, 0, this->regs[SS_BOMB2_PRIM_R], this->regs[SS_BOMB2_PRIM_G],
                        this->regs[SS_BOMB2_PRIM_B], this->regs[SS_BOMB2_PRIM_A]);
        gDPSetEnvColor(gfxCtx->polyXlu.thaGfx.p++, this->regs[SS_BOMB2_ENV_R], this->regs[SS_BOMB2_ENV_G],
                       this->regs[SS_BOMB2_ENV_B], 0);
        gSPSegment(gfxCtx->polyXlu.thaGfx.p++, 0x08, SEGMENTED_TO_VIRTUAL(D_8099FEE0[this->regs[SS_BOMB2_TEX_IDX]]));
...
void EffectSsBomb2_DrawLayered(GlobalContext* globalCtx, u32 index, EffectSs* this) {
    ...
    if (mtx != NULL) {
        ...
        if (mtx2 != NULL) {
            ...
            gDPSetEnvColor(gfxCtx->polyXlu.thaGfx.p++, this->regs[SS_BOMB2_ENV_R], this->regs[SS_BOMB2_ENV_G],
                           this->regs[SS_BOMB2_ENV_B], 0);
            gSPSegment(gfxCtx->polyXlu.thaGfx.p++, 0x08, SEGMENTED_TO_VIRTUAL(D_8099FF00[this->regs[SS_BOMB2_TEX_IDX]]));
            gSPDisplayList(gfxCtx->polyXlu.thaGfx.p++, D_0400BFE8);
            gSPDisplayList(gfxCtx->polyXlu.thaGfx.p++, D_0400C040);
            ...
            for (i = 1; i >= 0; i--) {
                ...
                gSPMatrix(gfxCtx->polyXlu.thaGfx.p++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_eff_ss_bomb2.c", 448),
