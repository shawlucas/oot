...
void EffectSsFireTail_Draw(GlobalContext* globalCtx, u32 index, EffectSs* this) {
    ...
    OPEN_DISPS(gfxCtx, "../z_eff_fire_tail.c", __LINE__);
    ...
    gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_eff_fire_tail.c", __LINE__),
    ...
    CLOSE_DISPS(gfxCtx, "../z_eff_fire_tail.c", __LINE__);
}
