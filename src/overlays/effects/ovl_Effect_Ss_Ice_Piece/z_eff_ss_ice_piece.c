...
void EffectSsIcePiece_Draw(GlobalContext* globalCtx, u32 index, EffectSs* this) {
    ...
    OPEN_DISPS(gfxCtx, "../z_eff_ice_piece.c", __LINE__);
    ...
    gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(gfxCtx, "../z_eff_ice_piece.c", __LINE__),
    ...
    CLOSE_DISPS(gfxCtx, "../z_eff_ice_piece.c", __LINE__);
}
