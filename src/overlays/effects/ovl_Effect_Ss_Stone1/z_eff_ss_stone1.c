...
void EffectSsStone1_Draw(GlobalContext* globalCtx, u32 index, EffectSs* this) {
    ...
    OPEN_DISPS(gfxCtx, "../z_eff_ss_stone1.c", __LINE__);
    ...
    gSPMatrix(POLY_XLU_DISP++, Matrix_NewMtx(gfxCtx, "../z_eff_ss_stone1.c", __LINE__),
    ...
    CLOSE_DISPS(gfxCtx, "../z_eff_ss_stone1.c", __LINE__);
}
