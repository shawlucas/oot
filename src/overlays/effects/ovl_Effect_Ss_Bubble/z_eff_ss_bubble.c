...
void EffectSsBubble_Draw(GlobalContext* globalCtx, u32 index, EffectSs* this) {
    ...
    OPEN_DISPS(gfxCtx, "../z_eff_ss_bubble.c", __LINE__);

    Matrix_Translate(this->pos.x, this->pos.y, this->pos.z, MTXMODE_NEW);
    Matrix_Scale(scale, scale, scale, MTXMODE_APPLY);
    gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(gfxCtx, "../z_eff_ss_bubble.c", __LINE__),
    ...
    CLOSE_DISPS(gfxCtx, "../z_eff_ss_bubble.c", __LINE__);
}
