...
static SceneSelectEntry sScenes[] = {
    ...
    { "24: Grave (Redead)", Select_LoadGame, 0x031C },
    { "25: Grave (Fairy's Fountain)", Select_LoadGame, 0x004B },
    { "26: Royal Family's Tomb", Select_LoadGame, 0x002D },
    { "27: Great Fairy's Fountain (Upgrades)", Select_LoadGame, 0x0315 },
    { "28: Fairy's Fountain (Healing Fairies)", Select_LoadGame, 0x036D },
    { "29: Great Fairy's Fountain (Spells)", Select_LoadGame, 0x0371 },
    { "30: Final Battle with Ganon", Select_LoadGame, 0x043F },
    ...
    { "34: Talon's House", Select_LoadGame, 0x004F },
    { "35: Ranch Silo", Select_LoadGame, 0x05D0 },
    { "36: Guard House", Select_LoadGame, 0x007E },
    { "37: Granny's Potion Shop", Select_LoadGame, 0x0072 },
    ...
    { "45: Carpenter Boss's House", Select_LoadGame, 0x02FD },
    { "46: Back Alley House (Man in Green)", Select_LoadGame, 0x043B },
    ...
    { "52: Gravekeeper's Hut", Select_LoadGame, 0x030D },
    ...
    { "84: Ganon's Tower", Select_LoadGame, 0x041B },
    { "85: Ganondorf's Lair", Select_LoadGame, 0x041F },
    { "86: Ice Cavern", Select_LoadGame, 0x0088 },
    { "87: Dampé's Grave", Select_LoadGame, 0x044F },
    { "88: Inside Ganon's Castle", Select_LoadGame, 0x0467 },
    { "89: Ganondorf's Death Scene & T ower Escape Exterior", Select_LoadGame, 0x0517 },
    { "90: Escaping Ganon's Tower 1", Select_LoadGame, 0x0179 },
    { "91: Escaping Ganon's Tower 2", Select_LoadGame, 0x01B5 },
    { "92: Escaping Ganon's Tower 3", Select_LoadGame, 0x03DC },
    { "93: Escaping Ganon's Tower 4", Select_LoadGame, 0x03E4 },
    { "94: Escaping Ganon's Tower", Select_LoadGame, 0x056C },
    ...
    { "99: Theives' Hideout 5", Select_LoadGame, 0x04AE },
    { "100: Thieves' Hideout 6", Select_LoadGame, 0x0570 },
    { "101: Grotto 0 - Gossip Stone & Chest", Select_LoadGame, 0x003F },
    { "102: Grotto 1 - Skulltula & Gold Skulltula", Select_LoadGame, 0x0598 },
    { "103: Grotto 2 - Business Scrub & Heart Piece", Select_LoadGame, 0x059C },
    { "104: Grotto 3 - Redeads", Select_LoadGame, 0x05A0 },
    { "105: Grotto 4 - 3 Business Scrubs", Select_LoadGame, 0x05A4 },
    { "106: Grotto 5 - Gossip Stone, Skulltula, Cow", Select_LoadGame, 0x05A8 },
    { "107: Grotto 6 - Octorock", Select_LoadGame, 0x05AC },
    { "108: Grotto 7 - Business Scrub & Deku Nut Upgrade", Select_LoadGame, 0x05B0 },
    { "109: Grotto 8 - 2 Wolfos", Select_LoadGame, 0x05B4 },
    { "110: Grotto 9 - Bombable Walls", Select_LoadGame, 0x05B8 },
    { "111: Grotto 10 - 2 Business Scrubs", Select_LoadGame, 0x05BC },
    { "112: Grotto 11 - Tektite & Heart Piece", Select_LoadGame, 0x05C0 },
    { "113: Grotto 12 - Deku Stage", Select_LoadGame, 0x05C4 },
    { "114: Grotto 13 - Rupees & Cow", Select_LoadGame, 0x05FC },
    ...
    { "118: Jungle Gym Test Map", Select_LoadGame, 0x0094 },
    { "119: Tresure Chest Test Room", Select_LoadGame, 0x0024 },
    ...
    { "Title Screen", (void*)Select_LoadTitle, 0x0000 },
};
...
void Select_PrintCutsceneSetting(SelectContext* this, GfxPrint* printer, u16 csIndex) {
    ...
    switch (csIndex) {
        ...
        case 0x8000:
            // clang-format off
            gSaveContext.dayTime = 0x8000; label = "Afternoon Kokiri";
            // clang-format on
            break;
        case 0xFFF0:
            // clang-format off
            gSaveContext.dayTime = 0x8000; label = "Cutscene 00";
            // clang-format on
            break;
        case 0xFFF1:
            label = "Cutscene 01";
...
void Select_Init(GameState* thisx) {
    ...
    this->staticSegment = GameState_Alloc(&this->state, size, "../z_select.c", __LINE__);
    DmaMgr_SendRequest1(this->staticSegment, _z_select_staticSegmentRomStart, size, "../z_select.c", __LINE__);
    gSaveContext.cutsceneIndex = 0x8000;
    gSaveContext.linkAge = 1;
}
