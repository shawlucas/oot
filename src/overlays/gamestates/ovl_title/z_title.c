...
void Title_Draw(TitleContext* this) {
    ...
    OPEN_DISPS(this->state.gfxCtx, "../z_title.c", __LINE__);
    ...
    gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(this->state.gfxCtx, "../z_title.c", __LINE__), G_MTX_LOAD);
    ...
    CLOSE_DISPS(this->state.gfxCtx, "../z_title.c", __LINE__);
}
...
void Title_Init(GameState* thisx) {
    ...
    this->staticSegment = GameState_Alloc(&this->state, size, "../z_title.c", __LINE__);
    osSyncPrintf("z_title.c\n");
    ASSERT(this->staticSegment != NULL, "this->staticSegment != NULL", "../z_title.c", __LINE__);
    DmaMgr_SendRequest1(this->staticSegment, (u32)_nintendo_rogo_staticSegmentRomStart, size, "../z_title.c", __LINE__);
    R_UPDATE_RATE = 1;
