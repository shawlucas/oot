...
void Locale_Init(void) {
    ...
    switch (sCartInfo.countryCode) {
        ...
        default:
            ...
            osSyncPrintf("Locale_Init: Cannot distinguish whether region is Japanese or American\n");
            LogUtils_HungupThread("../z_locale.c", __LINE__);
            osSyncPrintf(VT_RST);
            break;
    }

    osSyncPrintf("Locale_Init: Distinguish whether region is Japanese or American using controller 3\n");
}
