...
.L80070E7C:
/* AE801C 80070E7C 3C038012 */  lui   $v1, %hi(gDaySpeed) # $v1, 0x8012
/* AE8020 80070E80 2463FB40 */  addiu $v1, %lo(gDaySpeed) # addiu $v1, $v1, -0x4c0
...
.L80070E98:
/* AE8038 80070E98 3C038012 */   lui   $v1, %hi(gDaySpeed) # $v1, 0x8012
/* AE803C 80070E9C 2463FB40 */  addiu $v1, %lo(gDaySpeed) # addiu $v1, $v1, -0x4c0
...
.L80070EC8:
/* AE8068 80070EC8 3C038012 */  lui   $v1, %hi(gDaySpeed) # $v1, 0x8012
/* AE806C 80070ECC 2463FB40 */  addiu $v1, %lo(gDaySpeed) # addiu $v1, $v1, -0x4c0
