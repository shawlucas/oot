...
/* 0089C 80AF5DFC 3C038016 */  lui     $v1, %hi(gSaveContext)               ## $v1 = 80160000
/* 008A0 80AF5E00 2463E660 */  addiu   $v1, $v1, %lo(gSaveContext)           ## $v1 = 8015E660
...
/* 00904 80AF5E64 3C0F8012 */  lui     $t7, %hi(gItemSlots+0x7)                ## $t7 = 80120000
/* 00908 80AF5E68 51C0000E */  beql    $t6, $zero, .L80AF5EA4     
/* 0090C 80AF5E6C 24010056 */  addiu   $at, $zero, 0x0056         ## $at = 00000056
/* 00910 80AF5E70 91EF746B */  lbu     $t7, %lo(gItemSlots+0x7)($t7)           ## 8012746B
...
/* 00950 80AF5EB0 3C0C8012 */  lui     $t4, %hi(gBitFlags+0x38)                ## $t4 = 80120000
...
/* 00960 80AF5EC0 8D8C7158 */  lw      $t4, %lo(gBitFlags+0x38)($t4)           ## 80127158
...
/* 00990 80AF5EF0 3C0F8012 */  lui     $t7, %hi(gBitFlags+0x48)                 ## $t7 = 80120000
/* 00994 80AF5EF4 8DEF7168 */  lw      $t7, %lo(gBitFlags+0x48)($t7)           ## 80127168
